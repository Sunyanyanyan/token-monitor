...
USER_OPEN_ID = "ou_94bdf408e50126a28437a49e5e0342bd"

# 飞书API基础URL
BASE_URL = "https://open.feishu.cn/open-apis"

# 内容文件路径
CONTENT_FILE = "/root/.openclaw/workspace/docs/feishu-wiki-table.md"
...
def create_wikiDoc(access_token, content, user_open_id):
    """在Wiki中创建节点并写入内容"""
    # 先获取wiki的space_id
...
def main():
    ...
    # 创建wiki节点并写入内容
    print("\n🔄 创建Wiki节点并写入内容...")
    result = create_wikiDoc(tenant_token, content, USER_OPEN_ID)
    if result is None:
        return
